...
fn testnet_genesis(
    ...
    let argent_account_class =
        get_contract_class(include_bytes!("../../../cairo-contracts/build/ArgentAccount.json"), 0).try_into().unwrap();
    ...
    let argent_proxy_class =
        get_contract_class(include_bytes!("../../../cairo-contracts/build/Proxy.json"), 0).try_into().unwrap();
    ...
    let test_contract_class =
        get_contract_class(include_bytes!("../../../cairo-contracts/build/test.json"), 0).try_into().unwrap();
    ...
    let erc20_class: ContractClassWrapper =
        get_contract_class(include_bytes!("../../../cairo-contracts/build/ERC20.json"), 0).try_into().unwrap();
    ...
    let erc20_class_cairo_1: ContractClassWrapper =
    ...
    let erc721_class: ContractClassWrapper =
        get_contract_class(include_bytes!("../../../cairo-contracts/build/ERC721.json"), 0).try_into().unwrap();
    ...
    let udc_class: ContractClassWrapper =
        get_contract_class(include_bytes!("../../../cairo-contracts/build/UniversalDeployer.json"), 0)
            .try_into()
            .unwrap();
